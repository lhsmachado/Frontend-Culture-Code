  ...
  return (
    <S.ContainerMenu>
      <S.ButtonMenu onClick={() => handleButtonClick("profile")}>
        <S.ImageContainer customColors={selected == "profile"? "#502B6B" : "#F3E3FF"}>
          <img src={selected == "profile"? userIconSelected :userIcon} alt="" />
        </S.ImageContainer>
        <h4>Meus Dados</h4>
      </S.ButtonMenu>
      <S.ButtonMenu
      ...
      >
        <S.ImageContainer customColors={selected == "senha"? "#502B6B" : "#F3E3FF"}>
          <img src={selected == "senha"? passwordIconSelected :passwordIcon} alt="" />
        </S.ImageContainer>
        <h4>Alterar senha</h4>
      </S.ButtonMenu>
      <S.ButtonMenu
      ...
      >
        <S.ImageContainer customColors={selected == "resgates"? "#502B6B" : "#F3E3FF"}>
          <img src={selected == "resgates" ? cupomIconSelected :cupomIcon} alt="" />
        </S.ImageContainer>
        <h4>Meus Resgates</h4>
      </S.ButtonMenu>
      <S.ButtonMenu
      ...
      >
        <S.ImageContainer customColors={selected == "joias"? "#502B6B" : "#F3E3FF"}> 
          <img src={selected == "joias"? diamondIconSelected :diamondIcon} alt="" />
        </S.ImageContainer>
        <h4>Minhas jóias</h4>
      </S.ButtonMenu>
      <S.ButtonMenu
      ...
      >
        <S.ImageContainer customColors={selected == "sair"? "#502B6B" : "#F3E3FF"}>
